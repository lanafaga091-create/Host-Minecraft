...
// Ganti port ini kalau kamu menjalankan payment-confirm di port lain
// (mis. PORT=3001 node server.js di dalam folder payment-confirm).
const PAYMENT_CONFIRM_PORT = 3001;
function paymentConfirmBaseUrl(){
  return `${location.protocol}//${location.hostname}:${PAYMENT_CONFIRM_PORT}`;
}
